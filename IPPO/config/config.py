"""
Configuration dataclasses for IPPO training.
...
class LoggingConfig:
    ...
    project: str = "sumo-ippo-traffic"
    group: str = "cologne3"
    tags: List[str] = field(default_factory=lambda: ["ippo", "traffic-control"])
    use_wandb: bool = True
    log_dir: str = "logs"
