...
from mappo_traffic.config.config import ExperimentConfig, SumoConfig, NetworkConfig, MAPPOConfig, TrainingConfig, LoggingConfig
...
def get_fast_test_config() -> ExperimentConfig:
    ...
    config.training.n_train_envs = 2
    config.logging.use_wandb = False
    return config
